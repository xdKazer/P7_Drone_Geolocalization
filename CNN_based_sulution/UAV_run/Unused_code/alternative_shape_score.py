...
def get_shape_score(
    ...
    Checks:
      ...
      (removed)- s_scale_abs: absolute scale vs expected (with dead-band)
    ...
    """ 
    Removed as scale is to unceartain # =====================================================================
    ...
    # 5) Combine terms 
    # =====================================================================
    terms = np.array([s_w, s_h, s_ar, s_angle], dtype=np.float64)
